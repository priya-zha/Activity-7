...
var csvUrl = 'https://gist.githubusercontent.com/priya-zha/d89852ea8864c23b2af402c67f635973/raw/6ebc0a376c35adb05054091217541923d52f2726/penguins.csv';

// Function to parse the CSV and count species occurrences
var parseData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var data, speciesCount;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          speciesCount = d3.rollup(data, function (v) {
            return v.length;
          }, function (d) {
            return d.Species;
          }); // Prepare the pie chart data
          return _context.abrupt("return", Array.from(speciesCount, function (_ref2) {
...
var svg = d3.select("#pieChart").attr("width", width).attr("height", height).append("g").attr("transform", "translate(".concat(width / 2, ", ").concat(height / 2, ")"));
...
var drawChart = function drawChart(pieData) {
...
// Create the legend
var createLegend = function createLegend(pieData) {
  var legend = d3.select(".legend");
  pieData.forEach(function (d, i) {
    var legendItem = legend.append("div").attr("class", "legend-item");
    legendItem.append("rect").attr("width", 20).attr("height", 20).style("fill", color(d.species));
    legendItem.append("text").text(d.species).style("font-size", "16px").style("margin-left", "10px");
  });
};
...
//# sourceMappingURL=/Activity%207%20Question%201.e31bb0bc.js.map